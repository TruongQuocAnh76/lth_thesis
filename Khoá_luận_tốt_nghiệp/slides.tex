...
\frame{
    ...
    \begin{columns}
        \column{0.55\textwidth}
        \textbf{Ý tưởng:} Cắt tỉa tại thời điểm khởi tạo sao cho \textbf{mực độ gradient bị suy giảm ít nhất} sau khi tỉa.
        \vspace{0.2cm}
...
\frame{
    ...
    \begin{columns}
        ...
        \vspace{0.2cm}
        \begin{block}{Hàm mục tiêu (không dùng dữ liệu)}
...
\frame{
    ...
    \begin{columns}
        ...
        \begin{center}
            $S \in \{0.30,\ 0.40,\ 0.50,\ 0.60,\ 0.70,\ 0.80,\ 0.90\}$
        \end{center}
        \vspace{0.3cm}
