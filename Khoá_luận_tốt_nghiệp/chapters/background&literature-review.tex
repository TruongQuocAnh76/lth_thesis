\chapter{Nền tảng \& Tổng quan}
    ...
    \section{Phân loại thuật toán}
        ...
        \subsection{Nhóm cắt tỉa hỗn hợp}
            Hybrid Pruning: Một phương pháp cắt tỉa mới trong đó phần lớn các trọng số không quan trọng (khoảng 60-80\%) được loại bỏ trong một bước duy nhất \gls{one_shot_pruning}, sau đó thực hiện một giai đoạn tinh chỉnh dài hơn. Tiếp theo, các chu kỳ cắt tỉa lặp lại theo cấp số nhân (geometric-like) được áp dụng cho các trọng số còn lại để đạt được độ thưa mục tiêu với độ chính xác tối ưu \cite{hybrid}.
