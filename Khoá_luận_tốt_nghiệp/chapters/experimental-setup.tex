...
từ mạng nhỏ gọn đến mạng sâu có dung lượng lớn.
    ...
    thuật toán Hybrid-Improve khi không gian tìm kiếm tăng lên.
    ...
    \label{subsec:accuracy}
    	...
    	\textbf{Best Test Accuracy} (Độ chính xác kiểm tra tốt nhất, \%) là giá trị cao nhất đạt được trên tập kiểm tra trong toàn bộ quá trình huấn luyện/tinh chỉnh. Chỉ số này được trình bày để tham khảo thêm.
