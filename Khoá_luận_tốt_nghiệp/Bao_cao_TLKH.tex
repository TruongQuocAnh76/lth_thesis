...
\begin{abstract}
    ...
    tỉa one-shot động dựa trên Fisher Information Trace thay vì cố định theo kinh nghiệm, (2) sử 
    dụng Knowledge Distillation từ mô hình gốc để hướng dẫn phục hồi biểu diễn sau bước cắt tỉa lớn, 
    và (3) áp dụng lịch học warm-up tuyến tính tại đầu mỗi bước iterative để tránh hội tụ cục bộ. Kết 
