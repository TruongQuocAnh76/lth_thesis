            ...
            "iterations": [
                {
                    "iteration": 0,
                    "sparsity": 0.0,
                    "remaining_weights_fraction": 1.0,
                    "test_accuracy": best_test_acc,
                    "test_loss": iteration_history["test_losses"][-1] if iteration_history["test_losses"] else 0.0,
                    "train_losses": iteration_history.get("train_losses", []),
                    "train_accs": iteration_history.get("train_accs", []),
                    "test_losses": iteration_history.get("test_losses", []),
                    "test_accs": iteration_history.get("test_accs", []),
                    "train_accuracy_final": (iteration_history.get("train_accs")[-1] if iteration_history.get("train_accs") else 0),
                    "train_loss_final": (iteration_history.get("train_losses")[-1] if iteration_history.get("train_losses") else 0),
                    "best_test_accuracy": float(best_test_acc),
                    "layer_sparsities": get_sparsity(dense_masks),
                }
            ],
            "final_results": {},
        },
