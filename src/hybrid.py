...
def hybrid_pruning(
    ...
    oneshot_finetune_patience: int = 50,
    # -- Fine-tuning after each iterative step ----------------------------
    iter_finetune_max_epochs: int = 30,
